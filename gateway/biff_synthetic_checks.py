...
DEFAULT_SCENARIOS: tuple[SyntheticScenario, ...] = (
    ...
    SyntheticScenario(
        ...
        expected_action="kanban_admin",
        expected_runtime="kanban_admin",
        expected_toolsets=("kanban", "terminal"),
        max_tool_calls=6,
    ),
    SyntheticScenario(
        name="create_story_stays_biff_without_explicit_handoff",
    ...
    SyntheticScenario(
        name="engineering_work_stays_biff_without_explicit_handoff",
    ...
    *,
    ...
    checks: dict[str, tuple[bool, str, dict[str, Any]]] = {
        ...
        "loop_bounding_no_empty_search_loops": (
            ...
            and scenario_by_name["broad_secondbrain_deep_research_background"].expected_action == "route_bundle",
            "SecondBrain/Smart Connections lookups are bounded and broad work stays with Biff unless explicit handoff is requested",
            {},
        ),
        "update_notifications_noop_degrade": (
